...
const gameNodes = {
  prologue_start: {
    video: "prologue_intro.mp4",
    nextDecision: "dp1_prologue"
  },
  prologue_choice_a: {
    video: "prologue_choice_a.mp4",
    nextNode: "chapter1"
  },
  prologue_choice_b: {
    video: "prologue_choice_b.mp4",
    nextNode: "chapter1"
  },
  prologue_choice_c: {
    video: "prologue_choice_c.mp4",
    nextNode: "chapter1"
  },
  chapter1: {
    video: "ch1_main.mp4",
  ...
  ch1_choice_a: {
    video: "ch1_choice_a.mp4",
    nextNode: "ch1_ab_end"
  },
  ch1_choice_b: {
    video: "ch1_choice_b.mp4",
    nextNode: "ch1_ab_end"
  },
  ch1_ab_end: {
    video: "ch1_ab_end.mp4",
    nextNode: "chapter2"
  },
  ch1_choice_c: {
    video: "ch1_choice_c.mp4",
    nextDecision: "dp3_chapter1"
  },
  ch1_c_end1: {
    video: "ch1_c_end1.mp4",
    nextNode: "chapter2"
  },
  ch1_c_end2: {
    video: "ch1_c_end2.mp4",
    ending: "bad1"
  },
  chapter2: {
    video: "ch2_intro.mp4",
  ...
  ch2_choice_a: {
    video: "ch2_node1_b.mp4",
    nextNode: "ch2_node2"
  },
  ch2_choice_b: {
    video: "ch2_node1_a.mp4",
    nextNode: "ch2_node2"
  },
  ch2_node2: {
    video: "ch2_node2.mp4",
  ...
  ch2_dp5_choice_a: {
    video: "ch2_node2_a.mp4",
    nextNode: "chapter3"
  },
  ch2_dp5_choice_b: {
    video: "ch2_node2_b.mp4",
    nextNode: "chapter3"
  },
  ch2_dp5_choice_c: {
    video: "ch2_node2_c.mp4",
    ending: "bad2"
  },
  chapter3: {
    video: "ch3_intro.mp4",
  ...
  ch3_choice_a: {
    video: "ch3_scene1.mp4",
    nextNode: "victory"
  },
  ch3_choice_b: {
    video: "ch3_scene2.mp4",
    nextNode: "victory"
  },
  ch3_choice_c: {
    video: "ch3_scene3.mp4",
    nextNode: "bad_leadin"
  },
  bad_leadin: {
    video: "ch3_fail.mp4",
  ...
  victory: {
    video: "ch3_victory.mp4",
    nextDecision: "dp7_chapter3"
  },
  dp7_choice_a: {
    video: "ch3_return1.mp4",
    nextNode: "parade"
  },
  dp7_choice_b: {
    video: "ch3_return2.mp4",
    nextNode: "parade"
  },
  parade: {
    video: "ch3_parade.mp4",
    ending: "good"
  }
};
